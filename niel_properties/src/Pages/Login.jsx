                    ...
                    <form className="space-y-4">
                        ...
                        <div className='flex justify-between'>
                            <div className="flex items-center gap-3 pt-1">
                                ...
                                />
                                <label htmlFor="remember-me" className="text-gray-500 text-sm cursor-pointer select-none">
                                    Remember Me
                                </label>
                            </div>
                            ...
                            <Link
                                to="/forgot-password"
                                className="text-sm font-bold text-[#0047CC] hover:text-blue-800 hover:underline transition duration-200"
                            >
                                Forgot Password?
                            </Link>
                        </div>
