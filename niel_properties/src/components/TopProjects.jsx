    ...
    <section className="py-16 md:py-24 bg-white font-sans">
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          {/* Brand Tag (Hidden on mobile, visible on tablet+) */}
        ...
        {/* --- Projects Grid --- */}
        {/* 'items-stretch' ensures both columns are equal height on Desktop */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">

          {/* --- CARD 1 (Left): Logo Box + Text Below --- */}
          <div className="flex flex-col gap-6 group cursor-pointer h-full">
            ...
            <div className="relative border border-gray-400 rounded-[2rem] p-8 md:p-10 h-64 md:h-80 flex items-center justify-center transition-shadow duration-300 hover:shadow-xl bg-white w-full">
              ...
              {/* Image responsive sizing: w-48 on mobile, w-72 on tablet/desktop */}
              <img 
          ...
          {/* --- CARD 2 (Right): Full Image Background --- */}
          {/* h-80 on mobile/tablet, h-full on desktop to match left column */}
          <div className="relative rounded-[2rem] overflow-hidden h-80 lg:h-auto min-h-[320px] group cursor-pointer w-full">
