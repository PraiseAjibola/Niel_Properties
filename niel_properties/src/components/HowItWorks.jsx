                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                    ...
                    <div className="flex flex-col gap-8 h-full">
                        ...
                        {/* UPDATED CONTAINER CLASSES:
                           1. lg:-ml-24 -> Pulls the whole box left (the "cut" effect).
                           2. lg:w-[calc(100%+6rem)] -> Widens the box to compensate for the pull.
                           3. lg:rounded-l-none -> Removes left border radius for a cleaner edge cut.
                        */}
                        <div className="relative w-full rounded-3xl lg:rounded-l-none overflow-hidden h-64 lg:h-auto lg:flex-1 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.06)] lg:-ml-24 lg:w-[calc(100%+6rem)]">
                            ...
                            {/* UPDATED IMAGE CLASSES:
                               ...
                               This ensures the image actually fills the width of the border-gray-100 box.
                            */}
                            <img
                                src="/Works_img.png"
                                alt="Modern House"
                    ...
                    {/* --- RIGHT SIDE: Staggered Cards Grid --- */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 relative">
                        ...
                        <div className="flex flex-col gap-5 md:mt-12">
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-2xl transition duration-300 border border-gray-100 flex flex-col items-center text-center group">
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            {/* Card 4: Pay or Save */}
                            <div className="bg-white py-6 px-4 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-2xl transition duration-300 border border-gray-100 flex flex-col items-center text-center group">
                                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mb-4 group-hover:bg-blue-700 transition shrink-0">
