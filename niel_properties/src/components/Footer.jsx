                    ...
                    >
                        ...
                        <motion.div className="lg:col-span-2" variants={itemFade}>
                            ...
                            <div className="flex gap-4">
                                <Link to="#" className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-blue-900 transition duration-300">
                        ...
                        <motion.div variants={itemFade}>
                            ...
                            <ul className="space-y-4 text-sm text-blue-100/80">
                                ...
                                <li><Link to="/kyc" className="hover:text-white transition">Investment</Link></li>
                                <li><Link to="/how-it-works" className="hover:text-white transition">About</Link></li>
                        ...
                        <motion.div variants={itemFade}>
                            ...
                            <ul className="space-y-4 text-sm text-blue-100/80">
                                <li><Link to="/featured-properties" className="hover:text-white transition">Shortlets</Link></li>
                                <li><Link to="/featured-properties" className="hover:text-white transition">Apartments</Link></li>
                                <li><Link to="/featured-properties" className="hover:text-white transition">Lands</Link></li>
                                <li><Link to="/featured-properties" className="hover:text-white transition">Savings Plan</Link></li>
                            </ul>
                        </motion.div>
                        ...
                        <motion.div variants={itemFade}>
                            ...
                            <ul className="space-y-4 text-sm text-blue-100/80">
                                <li><Link to="#" className="hover:text-white transition">Help Center / FAQs</Link></li>
                                <li><Link to="/how-it-works" className="hover:text-white transition">How it Works</Link></li>
                                <li><Link to="/dashboard/referrals" className="hover:text-white transition">Referral Program</Link></li>
                                <li><Link to="/support-chat" className="hover:text-white transition">Chat with Support</Link></li>
                            </ul>
                        </motion.div>
                        ...
                        <motion.div variants={itemFade}>
                            ...
                            <ul className="space-y-4 text-sm text-blue-100/80">
                                ...
                                <li><Link to="/kyc" className="hover:text-white transition">KYC Policy</Link></li>
                            </ul>
                        </motion.div>
